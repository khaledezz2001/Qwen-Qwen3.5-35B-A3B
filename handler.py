...
# Disable CUDA forward-compatibility layer (causes Error 803 on newer host drivers or consumer GPUs)
os.environ.setdefault("VLLM_ENABLE_CUDA_COMPATIBILITY", "0")
